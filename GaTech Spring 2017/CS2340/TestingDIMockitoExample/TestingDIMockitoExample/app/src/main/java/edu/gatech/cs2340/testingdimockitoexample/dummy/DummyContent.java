 ...
 */
public class DummyContent implements IDataSource {
    ...
    private static DummyItem createDummyItem(int position) {
        return new DummyItem(String.valueOf(position), "Book " + position, makeDetails(position));
    }
    ...
    @Override
    public void addItem() {
        addItem(new DummyItem("newItem", "new content", "new details"));
    }
